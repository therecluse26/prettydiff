...
var markuppretty = function markuppretty_(options) {
    ...
    var safeSort    = global.safeSort,
        ...
        // * lines describes the preceeding space using: 2, 1, or 0 lines is populated in
        ...
        extlib      = function markuppretty__extlib(type) {
            var result = (type === "script")
                ? global.jspretty(options)
                : global.csspretty(options);
    ...
    (function markuppretty__options() {
        ...
        options.apacheVelocity  = (options.apacheVelocity === true || options.apacheVelocity === "true");
        options.attributetoken  = (options.attributetoken === true || options.attributetoken === "true");
        ...
        options.externalParser  = (typeof options.externalParser !== "string")
            ? ""
            : options.externalParser;
        options.force_attribute = (options.force_attribute === true || options.force_attribute === "true");
        ...
        options.jekyll          = (options.jekyll === true || options.jekyll === "true");
        options.jsx             = (options.jsx === true || options.jsx === "true");
        options.mode            = (options.mode === "parse" || options.mode === "diff" || options.mode === "minify" || options.mode === "analysis")
            ? options.mode
            : "beautify";
        options.nodeasync       = (options.nodeasync === true || options.nodeasync === "true");
        options.parseFormat     = (options.parseFormat === "sequential" || options.parseFormat === "htmltable")
            ? options.parseFormat
            : "parallel";
        options.parseSpace      = (options.parseSpace === true || options.parseSpace === "true");
        options.preserve        = (function markuppretty__options_preserve() {
        ...
        options.unformatted     = (options.unformatted === true || options.unformatted === "true");
        options.vertical        = (options.vertical === "jsonly" || options.vertical === "js" || options.vertical === "css" || options.vertical === "cssonly" || options.vertical === "all" || options.vertical === "true" || options.vertical === true)
            ? options.vertical
            : "none";
        wrap                    = (isNaN(options.wrap) === true || options.mode === "diff" || options.textpreserve === true)
            ? 0
            : Number(options.wrap);
        if (options.vertical === true || options.vertical === "true") {
        ...
        var a             = 0,
            ...
            tag           = function markuppretty__tokenize_tag(end) {
                ...
                for (a = a; a < c; a += 1) {
                    ...
                    if (comment === true) {
                        ...
                        } else if (b[a] === quote.charAt(quote.length - 1) && ((global.jsxstatus === true && end === "}" && (b[a - 1] !== "\\" || slashy() === false)) || global.jsxstatus === false || end !== "}")) {
                ...
                if (tname === "comment" && element.slice(0, 2) === "{%") {
                    ...
                    begin.push(parent[parent.length - 1][1]);
                    stats.template[0] += 1;
                    stats.template[1] += element.length;
                ...
                if (parseFail === true) {
                    if (element.indexOf("<!--<![") === 0) {
                        ...
                        if (element.indexOf("</") > 0) {
                            ...
                            begin.push(parent[parent.length - 1][1]);
                            stats.end[0] += 1;
                            stats.end[1] += token[token.length - 1].length;
                ...
                cheat = (function markuppretty__tokenize_tag_cheat() {
                            ...
                            for (aa = token.length - 1; aa > -1; aa -= 1) {
                                ...
                                if (bb === 0 && token[aa].toLowerCase().indexOf(vname) === 1) {
                                    if (cftags[tagName(token[aa])] !== undefined) {
                                        ...
                                        types[aa] = "start";
                                        stats.singleton[0] -= 1;
                                        stats.singleton[1] -= token[token.length - 1].length;
                                        stats.start[0] += 1;
                                        stats.start[1] += token[token.length - 1].length;
                                    }
                    ...
                    if ((tname === "script" || tname === "style" || tname === "cfscript") && element.slice(element.length - 2) !== "/>") {
                        ...
                        if (tname === "script" && (type === "" || type === "text/javascript" || type === "babel" || type === "application/javascript" || type === "application/x-javascript" || type === "text/ecmascript" || type === "application/ecmascript" || type === "text/jsx" || type === "application/jsx" || type === "text/cjs")) {
                            ext = true;
                        ...
                        if (options.jsx === false) {
                            if (tname === "li") {
                                if (litag === list && (list !== 0 || (list === 0 && types.length > 0 && types[types.length - 1].indexOf("template") < 0))) {
                                    for (d = types.length - 1; d > -1; d -= 1) {
                                        if (types[d] === "start" || types[d] === "template_start") {
                                            ee -= 1;
                                        } else if (types[d] === "end" || types[d] === "template_end") {
                                            ee += 1;
                                        }
                                        if (ee === -1 && tagName(token[d]) === "li") {
                                            liend = true;
                                            break;
                                        }
                                        if (ee < 0) {
                    ...
                    if (tname.slice(0, 2) === "cf") {
                        if (tname === "cfelse" || tname === "cfelseif") {
                            ...
                            begin.push(parent[parent.length - 1][1]);
                            stats.template[0] += 1;
                            stats.template[1] += token[token.length - 1].length;
                            singleton         = true;
                            return false;
                        }
                ...
                if (simple === true && preserve === false && ignoreme === true && end === ">" && element.slice(element.length - 2) !== "/>") {
                    ...
                    if (options.mode === "diff") {
                        ...
                        if (options.quotes === "single") {
                            attrs[attrs.length - 1] = ["data-prettydiff-ignore='true'"];
                        } else {
                            attrs[attrs.length - 1] = ["data-prettydiff-ignore=\"true\""];
                        }
                    }
                ...
                if (preserve === true) {
                    ...
                    begin.push(parent[parent.length - 1][1]);
                    stats.ignore[0] += 1;
                    stats.ignore[1] += token[token.length - 1].length;
                } else {
                    ...
                    if (types[types.length - 1].indexOf("template") > -1) {
                        ...
                        stats[types[types.length - 1]][0] += 1;
                        stats[types[types.length - 1]][1] += token[token.length - 1].length;
                    }
                }
                ...
                if ((types[e] === "start" || types[e] === "singleton") && options.mode === "parse" && attrs[e].length > 0) {
                    bcount = attrs[e].length;
                    for (f = 0; f < bcount; f += 1) {
                        attrs.push([]);
                        begin.push(begin[e]);
                        if (daddy[e] === "root") {
                            daddy.push(tname);
            ...
            content       = function markuppretty__tokenize_content() {
                ...
                for (a = a; a < c; a += 1) {
                    ...
                    // external code requires additional parsing to look for the appropriate end tag,
                    // but that end tag cannot be quoted or commented
                    if (ext === true) {
                        if (quote === "") {
                            if (b[a] === "/") {
                                if (b[a + 1] === "*") {
                            ...
                            if (name === "cfscript" && end === "</cfscript") {
                                ...
                                begin.push(parent[parent.length - 1][1]);
                                stats.script[0] += 1;
                                stats.script[1] += token[token.length - 1].length;
                            ...
                            if (name === "style") {
                                ...
                                if (end === "</style") {
                                    ...
                                    begin.push(parent[parent.length - 1][1]);
                                    stats.style[0] += 1;
                                    stats.style[1] += token[token.length - 1].length;
                    ...
                    if (square === true && b[a] === "]") {
                        ...
                        stats.content[0] += 1;
                        stats.content[1] += token[token.length - 1].length;
                        daddy.push(parent[parent.length - 1][0]);
                        begin.push(parent[parent.length - 1][1]);
                        return types.push("content");
                    }
    ...
    if (token.length === 0) {
        ...
        if (global.meta === undefined) {
            global.meta = {};
        }
        global.meta.error = "Error: source does not appear to be markup.";
        ...
        return (function markuppretty__parse() {
            var a        = 0,
                ...
                def      = {
                    ...
                    daddy: "string - Tag name of the parent element. Tokens of type 'template_start' are not considered as parent elements.  End tags reflect their matching start tag.",
                    jscom: "boolean - Whether the token is a JavaScript comment if in JSX format.",
                    linen: "number - The line number in the original source where the token started, which i" +
                               "s used for reporting and analysis.",
                    lines: "number - Whether the token is preceeded any space and/or line breaks in the orig" +
                               "inal code source.",
                    presv: "boolean - Whether the token is preserved verbatim as found.  Useful for comments" +
                               " and HTML 'pre' tags.",
                    token: "string - The parsed code tokens.",
                    types: "string - Data types of the tokens: cdata, comment, conditional, content, end, ig" +
                               "nore, linepreserve, script, sgml, singleton, start, template, template_else, tem" +
                               "plate_end, template_start, xml"
                },
                ...
                attApply = function markuppretty__parse_attApply() {
                    var string = "",
                        ...
                        atty   = attrs[a];
                    if (presv[a] === true) {
                        token[a] = toke.replace(" ", " " + atty.join(" "));
                    } else {
                        ...
                        xlen     = (string === "/>")
                            ? 3
                            : 2;
                        token[a] = (toke.slice(0, toke.length - xlen) + " " + atty.join(" ") + string);
                    }
                };
            ...
            for (a = 0; a < c; a += 1) {
                wspace = "";
                if (attrs[a].length > 0 && options.unformatted === false) {
                    attApply();
                }
                ...
                if (options.parseFormat !== "htmltable") {
                    if (types[a] === "script" && global.jspretty !== undefined) {
                        options.source = token[a];
                        token[a]       = global.jspretty(options).data;
                    } else if (types[a] === "style" && global.csspretty !== undefined) {
                        options.source = token[a];
                        token[a]       = global.csspretty(options).data;
                    }
                }
            ...
            if (options.parseFormat === "htmltable") {
                return (function csspretty__parse_html() {
                    var report = [],
                        ...
                        aa     = 0,
                        len    = 0;
                    if (options.attributetoken === false) {
                        header = header + "<th>attrs</th>";
                    }
                    header = header + "<th>linen</th><th>jscom</th><th>presv</th><th>daddy</th><th>begin</th><th>lines</th></tr>";
                    report.push("<table summary='markup parse table'><thead>");
                    report.push(header);
                    report.push("</thead><tbody>");
                    len = token.length;
                    for (aa = 0; aa < len; aa += 1) {
                        if (types[aa] === "script" && global.jspretty !== undefined) {
                            options.source = token[aa];
                            report.push("<tr><td colspan=\"10\" class=\"nested\">");
                            report.push(global.jspretty(options).data.replace("<thead>", "<thead><tr><th colspan=\"6\" class=\"nested\">JavaScript tokens</th></tr>"));
                            report.push("</td></tr>");
                            report.push("<tr><th colspan=\"10\" class=\"nested\">Markup tokens</th></tr>");
                            report.push(header);
                        } else if (types[aa] === "style" && global.csspretty !== undefined) {
                            options.source = token[aa];
                            report.push("<tr><td colspan=\"10\" class=\"nested\">");
                            report.push(global.csspretty(options).data.replace("<thead>", "<thead><tr><th colspan=\"4\" class=\"nested\">CSS tokens</th></tr>"));
                            report.push("</td></tr>");
                            report.push("<tr><th colspan=\"10\" class=\"nested\">Markup tokens</th></tr>");
                            report.push(header);
                        } else {
                            ...
                            if (options.attributetoken === false) {
                                ...
                                report.push(attrs[aa].join(", ").replace(/&/g, "&amp;").replace(/>/g, "&gt;").replace(/</g, "&lt;"));
                                report.push("</td><td>");
                            } else {
                                report.push("<td>");
                            }
    ...
    output = (function markuppretty__beautify() {
        var a            = 0,
            ...
            script       = function markuppretty__beautify_script(twig) {
                ...
                if ((/^(\s+\{)/).test(token[a]) && global.jsxstatus === true) {
                    ...
                    if (token[a].indexOf(";") < 0 && token[a].replace(/^(\{\s+)/, "").replace(/(\s+\})$/, "").indexOf("\n") < 0) {
                        token[a] = token[a].replace(/^(\{\s+)/, "{").replace(/(\s+\})$/, "}");
                    }
                } else if (twig === true) {
            ...
            apply        = function markuppretty__apply() {
                var x            = 0,
                    y            = level.length,
                    build        = [],
                    //tab builds out the character sequence for one step of indentation
                    ind          = (function markuppretty__apply_tab() {
                        var aa   = 0,
                            indy = [options.inchar],
                    ...
                    // of code
                    nl           = function markuppretty__apply_nl(indy, item) {
                        var aa          = 0,
                            indentation = [lf];
                        if (options.mode === "minify") {
                    ...
                    wrapper      = function markuppretty__apply_wrapper() {
                        ...
                        if (list.length > 0) {
                            ...
                            if ((types[x] === "template_start" || types[x] === "template" || types[x] === "template_else") && options.jsx === false && typeof global.jspretty === "function") {
                                len = list.length;
                                for (b = 0; b < len; b += 1) {
                                    xlen = list[b].indexOf("{");
                            ...
                            indy = (function markuppretty__apply_wrapper_indy() {
                                var atline = lf,
                                    atnum  = lev + 1;
                                do {
                                    atline = atline + ind;
                            ...
                            if (wrap === 0 || len <= wrap || tname === "cfset" || tname === "cfreturn" || tname === "cfif" || tname === "cfelseif") {
                                if (presv[x] === true) {
                                    ...
                                    xlen   = (string === "/>")
                                        ...
                                        : 2;
                                    if (options.force_attribute === true) {
                                        token[x] = (token[x].slice(0, token[x].length - xlen) + indy + atty + string);
                                    } else {
                                        token[x] = (token[x].slice(0, token[x].length - xlen) + " " + atty + string);
                                    }
                                }
                    ...
                    jsxattribute = function markuppretty__apply_jsxattribute() {
                        var attr     = attrs[x],
                            ...
                            xx       = attr.length,
                            value    = [],
                            inlevel  = options.inlevel + level[x],
                            inle     = options.inlevel,
                            mode     = options.mode,
                        ...
                        for (b = 0; b < xx; b += 1) {
                            ...
                            if (value[1].charAt(0) === "{") {
                                ...
                                value[1]         = extlib("script");
                                options.mode     = mode;
                                options.inlevel  = inle;
                                options.vertical = vertical;
                                attrs[x][b]      = value[0] + "={" + value[1].replace(/^\s+/, "") + "}";
                            }
                        }
                    },
                    linepreserve = function markuppretty__apply_linepreserve() {
                        ...
                        if (types[x + 1] === "template_end" && out[out.length - 1].indexOf(ind) > 0) {
                            out.pop();
                        }
                        token[x] = out.join("");
                    };
                for (x = 0; x < y; x += 1) {
                    if (options.jsx === true && attrs[x].length > 0) {
                        jsxattribute();
                    }
                    if (jscom[x] === true) {
                        attrcom();
                    } else if (types[x] === "content") {
                        if (presv[x] === true) {
                            linepreserve();
                        } else if (wrap > 0 && token[x].length > wrap && options.mode === "beautify") {
                            wrapper();
                        }
                    } else if (options.unformatted === false && options.mode === "beautify" && presv[x] === false && (attrs[x].length > 0 || (wrap > 0 && token[x].length > wrap)) && (types[x] === "content" || types[x] === "start" || types[x] === "singleton" || types[x] === "template_start" || types[x] === "template") && (types[x] !== "singleton" || token[x].charAt(0) !== "{")) {
                        wrapper();
                    } else if (options.unformatted === false && attrs[x].length > 0) {
                        token[x] = token[x].replace(" ", " " + attrs[x].join(" "));
                    ...
                    if (token[x] !== "</prettydiffli>" && jscom[x] === false) {
                        if ((types[x] === "template" || types[x] === "template_start") && types[x - 1] === "content" && presv[x - 1] === true && options.mode === "beautify" && level[x] === "x") {
                            build.push(" ");
                        }
                        if (isNaN(level[x]) === false) {
                            if (options.mode === "minify") {
                                build.push(" ");
                            } else {
                                nl(level[x], build);
        ...
        if (options.mode !== "minify") {
            for (a = 0; a < c; a += 1) {
                if (twigStart.test(token[a]) === true && twigEnd.test(token[a]) === true && (/^(\{%\s*((comment)|(else))\s*%)/).test(token[a]) === false) {
                    script(true);
                }
                if (types[a] === "start") {
                    level.push(indent);
                ...
                if (types[a] === "template" || types[a] === "template_start") {
                    extlist.push(a);
                }
                if (types[a] !== "content" && types[a] !== "comment" && types[a - 1] === "content" && types[a - 2] !== "linepreserve" && lprescount.length > 0) {
                    level[a] = "x";
                }
                if (lines[a] === 0 && (ltype === "content" || (ltype === "script" && token[a - 1].charAt(0) === "{" && global.jsxstatus === true))) {
                    level[a] = "x";
                }
                ltype = types[a];
                lline = lines[a];
        ...
        level[0] = 0;
        if (options.api === "dom" || options.api === "wsf" || options.externalParser === "" || extlist.length < 1) {
            return apply();
        }
        if (global.external !== undefined) {
            global.external({
                callback: apply,
                command : options.externalParser,
                items   : extlist,
                tokens  : token
            });
        }
    ...
    if (options.mode === "analysis") {
        options.accessibility = true;
        return (function markuppretty__apply_summary() {
            var len           = token.length,
                ...
                parseErrors   = (function markuppretty__apply_summary_parseErrors() {
                    ...
                    if (parseError.length > 1) {
                        globalerror     = parseError[0].replace(binfix, "");
                    }
                    if (x === 0) {
                        return "";
                    }
            ...
            if (options.accessibility === true) {
                if (options.nodeasync === true) {
                    return [
                        sum
                            .join("")
                            .replace("<div class='report'>", "<p><strong>Total potential accessibility violations:</strong> <em>" + data.violations + "</em></p> <div class='report'>"),
                        globalerror
                    ];
                }
                return sum
...
if (typeof require === "function" && typeof ace !== "object") {
    (function glib_markuppretty() {
        ...
        if (global.external === undefined) {
            global.external = require(localPath + "/external.js").api;
        }
